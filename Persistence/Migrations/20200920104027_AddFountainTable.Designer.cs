...
namespace Persistence.Migrations
{
    ...
    [Migration("20200920104027_AddFountainTable")]
    partial class AddFountainTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.IndustryEstablishment", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ExpertReferDate")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<int?>("MovedToDepartment")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.IndustryEstablishmentPreviousDepartment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PreviousIndustryEstablishmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PreviousIndustryEstablishmentId");

                    b.ToTable("IndustryEstablishmentPreviousDepartments");
                });
            ...
            modelBuilder.Entity("Core.Entities.IndustryEstablishment", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Industry", "Industry")
                        .WithMany("IndustryEstablishments")
                        .HasForeignKey("IndustryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.IndustryEstablishmentPreviousDepartment", b =>
                {
                    b.HasOne("Core.Entities.IndustryEstablishment", "IndustryEstablishment")
                        .WithMany("PreviousDepartments")
                        .HasForeignKey("IndustryEstablishmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.IndustryEstablishment", "PreviousIndustryEstablishment")
                        .WithMany()
                        .HasForeignKey("PreviousIndustryEstablishmentId")
                        .HasConstraintName("FK_IndustryEstablishmentPreviousDepartments_IndustryEstablishm~1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
