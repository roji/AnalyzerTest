...
namespace Persistence.Migrations
{
    ...
    [Migration("20201015121234_AddIndustryMonitoringReferenceAndReferredTables")]
    partial class AddIndustryMonitoringReferenceAndReferredTables
    {
            ...
            modelBuilder.Entity("Core.Entities.IndustryMonitoringReference", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2020, 10, 15, 12, 12, 32, 47, DateTimeKind.Unspecified).AddTicks(6556), new TimeSpan(0, 0, 0, 0, 0)));
