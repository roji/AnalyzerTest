...
{
   public partial class ChangePhaseOneMonitoringViewQuery : Migration
   {
      protected override void Up(MigrationBuilder migrationBuilder)
      {
         var deleteCmd = @"DROP VIEW IF EXISTS `v_industryphaseonemonitoringmaplist`;";
         ...
         SELECT
            ...
            FROM
               ...
               LEFT JOIN industrialunitssamplingresults iusr ON iusr.IndustryId = industries.Id 
               AND iusr.FinalSave = TRUE 
            WHERE
               isic4.`Data` IN (
                  1520,
                  2101,
