...
namespace Persistence.Migrations
{
    ...
    [Migration("20200805072926_FixEstablishmentInspectionDateForeignKeyProblem")]
    partial class FixEstablishmentInspectionDateForeignKeyProblem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.IndustryEstablishment", b =>
                {
                    ...
                    b.Property<int?>("StateOfficeExpertId")
                        .HasColumnType("int");

                    b.Property<DateTimeOffset?>("StateOfficeExpertReferDate")
                        .HasColumnType("datetime(6)");
                    ...
                    b.HasIndex("StateOfficeExpertId");
            ...
            modelBuilder.Entity("Core.Entities.IndustryEstablishmentInspectionInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ExpertTheory")
                        .HasColumnType("longtext");
                    ...
                    b.ToTable("IndustryEstablishmentInspectionInfos");
                });

            modelBuilder.Entity("Core.Entities.IndustryEstablishmentInspectionInfoVisitor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("IndustryEstablishmentInspectionInfoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IndustryEstablishmentInspectionInfoId");

                    b.ToTable("IndustryEstablishmentInspectionInfoVisitors");
                });
            ...
            modelBuilder.Entity("Core.Entities.IndustryEstablishment", b =>
                {
                    ...
                    b.HasOne("Core.Entities.User", "StateOfficeExpert")
                        .WithMany()
                        .HasForeignKey("StateOfficeExpertId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Core.Entities.IndustryEstablishmentInspectionInfoVisitor", b =>
                {
                    b.HasOne("Core.Entities.IndustryEstablishmentInspectionInfo", "IndustryEstablishmentInspectionInfo")
                        .WithMany("Visitors")
                        .HasForeignKey("IndustryEstablishmentInspectionInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
