...
namespace Persistence.Migrations
{
    ...
    [Migration("20200125114538_AddHunterViolationAndRelatedTables")]
    partial class AddHunterViolationAndRelatedTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.HunterAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("HunterAddresses");
                });

            modelBuilder.Entity("Core.Entities.HunterInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<bool?>("SurvivalStatus");
            ...
            modelBuilder.Entity("Core.Entities.HunterViolation", b =>
                {
                    ...
                    b.Property<string>("FounderPartnerAddress");

                    b.Property<string>("FounderPartnerFullName");

                    b.Property<string>("FounderPartnerMobile");

                    b.Property<string>("FounderPartnerNationalCode");
                    ...
                    b.Property<string>("ViolatorPartnerAddress");

                    b.Property<string>("ViolatorPartnerFullName");

                    b.Property<string>("ViolatorPartnerMobile");

                    b.Property<string>("ViolatorPartnerNationalCode");
            ...
            modelBuilder.Entity("Core.Entities.WasteTransport", b =>
                {
                    ...
                    b.Property<string>("DesAdminAgreementFileNameId")
                        .HasMaxLength(38);

                    b.Property<string>("Description");

                    b.Property<string>("EliminationFormFileNameId")
                        .HasMaxLength(38);
                    ...
                    b.Property<string>("SaleInvoiceFileNameId")
                        .HasMaxLength(38);
                    ...
                    b.HasIndex("DesAdminAgreementFileNameId");

                    b.HasIndex("EliminationFormFileNameId");

                    b.HasIndex("LoadingSupervisionAgendaFileNameId");

                    b.HasIndex("RecieverIndustryId");

                    b.HasIndex("SaleInvoiceFileNameId");
            ...
            modelBuilder.Entity("Core.Entities.HunterAddress", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Hunter", "Hunter")
                        .WithOne("Address")
                        .HasForeignKey("Core.Entities.HunterAddress", "HunterId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Core.Entities.HunterInformation", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Hunter", "Hunter")
                        .WithOne("Information")
                        .HasForeignKey("Core.Entities.HunterInformation", "HunterId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Core.Entities.EnumData", "Religion")
                        .WithMany()
                    ...
                    b.OwnsOne("Core.Entities.Address", "StationAddress", b1 =>
                        {
                            ...
                            b1.HasOne("Core.Entities.HydrometryStation")
                                .WithOne("StationAddress")
                                .HasForeignKey("Core.Entities.Address", "HydrometryStationId")
                                .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Core.Entities.WasteTransport", b =>
                {
                    b.HasOne("Core.Entities.Upload", "DesAdminAgreementFileName")
                        .WithMany()
                        .HasForeignKey("DesAdminAgreementFileNameId");

                    b.HasOne("Core.Entities.Upload", "EliminationFormFileName")
                        .WithMany()
                        .HasForeignKey("EliminationFormFileNameId");
                    ...
                    b.HasOne("Core.Entities.Upload", "SaleInvoiceFileName")
                        .WithMany()
                        .HasForeignKey("SaleInvoiceFileNameId");
                    ...
                    b.OwnsOne("Core.Entities.Address", "StationAddress", b1 =>
                        {
                            ...
                            b1.HasOne("Core.Entities.WaterOnlineQualityMonitoringStation")
                                .WithOne("StationAddress")
                                .HasForeignKey("Core.Entities.Address", "WaterOnlineQualityMonitoringStationId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                    ...
                    b.OwnsOne("Core.Entities.Person", "Manager", b1 =>
                        {
                            ...
                            b1.HasOne("Core.Entities.WaterOnlineQualityMonitoringStation")
                                .WithOne("Manager")
                                .HasForeignKey("Core.Entities.Person", "WaterOnlineQualityMonitoringStationId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
                    ...
                    b.OwnsOne("Core.Entities.Address", "StationAddress", b1 =>
                        {
                            ...
                            b1.HasOne("Core.Entities.WaterQualityMonitoringStation")
                                .WithOne("StationAddress")
                                .HasForeignKey("Core.Entities.Address", "WaterQualityMonitoringStationId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
