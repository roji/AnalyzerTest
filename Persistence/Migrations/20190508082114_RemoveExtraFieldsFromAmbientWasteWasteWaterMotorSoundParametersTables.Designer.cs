...
namespace Persistence.Migrations
{
    ...
    [Migration("20190508082114_RemoveExtraFieldsFromAmbientWasteWasteWaterMotorSoundParametersTables")]
    partial class RemoveExtraFieldsFromAmbientWasteWasteWaterMotorSoundParametersTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.EnergyConsumption", b =>
                {
                    ...
                    b.Property<int?>("EcDailyAverageConsumption");

                    b.Property<int?>("EcMonthlyAverageConsumption");

                    b.Property<string>("EcSupplySourceLocationName");

                    b.Property<int?>("EcYearlyAverageConsumption");

                    b.Property<int?>("GcDailyAverageConsumption");

                    b.Property<int?>("GcMonthlyAverageConsumption");

                    b.Property<string>("GcSupplySourceLocationName");

                    b.Property<int?>("GcYearlyAverageConsumption");

                    b.Property<int?>("GlcDailyAverageConsumption");

                    b.Property<int?>("GlcMonthlyAverageConsumption");

                    b.Property<string>("GlcSupplySourceLocationName");

                    b.Property<int?>("GlcYearlyAverageConsumption");
                    ...
                    b.Property<int?>("McDailyAverageConsumption");

                    b.Property<int?>("McMonthlyAverageConsumption");

                    b.Property<string>("McSupplySourceLocationName");

                    b.Property<int?>("McYearlyAverageConsumption");
            ...
            modelBuilder.Entity("Core.Entities.IndustrialUnitsSamplingResult", b =>
                {
                    ...
                    b.Property<int>("SamplerExpertId");

                    b.Property<string>("SamplingExpertsDescription");

                    b.Property<int>("TechnicalAssistantVerifierId");
                    ...
                    b.HasIndex("SamplerExpertId");

                    b.HasIndex("TechnicalAssistantVerifierId");
            ...
            modelBuilder.Entity("Core.Entities.MonitoringInfo", b =>
                {
                    ...
                    b.Property<bool?>("AssessmentStatus");
            ...
            modelBuilder.Entity("Core.Entities.MonitoringParameters", b =>
                {
                    ...
                    b.Property<int>("LimitAmountQuantity");
                    ...
                    b.Property<int>("PollutionLimitQuantity");
            ...
            modelBuilder.Entity("Core.Entities.MotorVehiclesParametersResults", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<double>("BuildYear");

                    b.Property<bool>("GasolineOrDiesel");
                    ...
                    b.ToTable("MotorVehiclesParametersResults");
                });
            ...
            modelBuilder.Entity("Core.Entities.WaterConsumption", b =>
                {
                    ...
                    b.Property<int?>("CvDailyAverageConsumption");

                    b.Property<int?>("CvMonthlyAverageConsumption");

                    b.Property<string>("CvSupplySourceLocationName");

                    b.Property<int?>("CvYearlyAverageConsumption");

                    b.Property<string>("CwConsumptionPlacesIds");

                    b.Property<string>("GwConsumptionPlacesIds");

                    b.Property<int?>("GwDailyAverageConsumption");

                    b.Property<int?>("GwMonthlyAverageConsumption");

                    b.Property<string>("GwSupplySourceLocationName");

                    b.Property<int?>("GwYearlyAverageConsumption");
                    ...
                    b.Property<int?>("SeawDailyAverageConsumption");

                    b.Property<int?>("SeawMonthlyAverageConsumption");

                    b.Property<string>("SeawSupplySourceLocationName");

                    b.Property<int?>("SeawYearlyAverageConsumption");

                    b.Property<string>("SwConsumptionPlacesIds");

                    b.Property<int?>("SwDailyAverageConsumption");

                    b.Property<int?>("SwMonthlyAverageConsumption");

                    b.Property<string>("SwSupplySourceLocationName");

                    b.Property<int?>("SwYearlyAverageConsumption");
            ...
            modelBuilder.Entity("Core.Entities.IndustrialUnitsSamplingResult", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Personnel", "SamplerExpert")
                        .WithMany()
                        .HasForeignKey("SamplerExpertId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Core.Entities.Personnel", "TechnicalAssistantVerifier")
                        .WithMany()
                        .HasForeignKey("TechnicalAssistantVerifierId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Core.Entities.Personnel", "Tester")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Entities.Industry", b =>
                {
                    ...
                    b.HasOne("Core.Entities.User", "RelatedUser")
                        .WithOne()
                        .HasForeignKey("Core.Entities.Industry", "RelatedUserId")
                    ...
                    b.OwnsOne("Core.Entities.Address", "CentralOfficeAddress", b1 =>
                        {
                            ...
                            b1.OwnsOne("Core.Entities.Contact", "ContactInfo", b2 =>
                                {
                                    b2.Property<int>("AddressIndustryId");
                                    ...
                                    b2.HasKey("AddressIndustryId");

                                    b2.ToTable("Industry_OfficeAddresses");

                                    b2.HasOne("Core.Entities.Address")
                                        .WithOne("ContactInfo")
                                        .HasForeignKey("Core.Entities.Contact", "AddressIndustryId")
                                        .OnDelete(DeleteBehavior.Cascade);
                                });

                            b1.OwnsOne("Core.Entities.GeoLocation", "Geo", b2 =>
                                {
                                    b2.Property<int>("AddressIndustryId");

                                    b2.Property<string>("Elevation");
                                    ...
                                    b2.HasOne("Core.Entities.Address")
                                        .WithOne("Geo")
                                        .HasForeignKey("Core.Entities.GeoLocation", "AddressIndustryId")
                                        .OnDelete(DeleteBehavior.Cascade);
                                });
                        });
                            ...
                            b1.OwnsOne("Core.Entities.Contact", "ContactInfo", b2 =>
                                {
                                    ...
                                    b2.ToTable("Industry_WorkshopAddresses");
                    ...
                    b.OwnsOne("Core.Entities.Person", "Manager", b1 =>
                        {
                            ...
                            b1.OwnsOne("Core.Entities.Contact", "ContactInfo", b2 =>
                                {
                                    b2.Property<int>("PersonIndustryId");
                                    ...
                                    b2.HasKey("PersonIndustryId");

                                    b2.ToTable("Industry_Managers");

                                    b2.HasOne("Core.Entities.Person")
                                        .WithOne("ContactInfo")
                                        .HasForeignKey("Core.Entities.Contact", "PersonIndustryId")
                                        .OnDelete(DeleteBehavior.Cascade);
                                });
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.Lab", b =>
                {
                    ...
                    b.HasOne("Core.Entities.User", "RelatedUser")
                        .WithOne()
                        .HasForeignKey("Core.Entities.Lab", "RelatedUserId")
                        .OnDelete(DeleteBehavior.SetNull);
                            ...
                            b1.OwnsOne("Core.Entities.Contact", "ContactInfo", b2 =>
                                {
                                    ...
                                    b2.HasKey("AddressLabId");

                                    b2.ToTable("Lab_Addresses");

                                    b2.HasOne("Core.Entities.Address")
                                        .WithOne("ContactInfo")
                                        .HasForeignKey("Core.Entities.Contact", "AddressLabId")
                                        .OnDelete(DeleteBehavior.Cascade);
                                });
                            ...
                            b1.OwnsOne("Core.Entities.GeoLocation", "Geo", b2 =>
                                {
                                    ...
                                    b2.HasOne("Core.Entities.Address")
                                        .WithOne("Geo")
                                        .HasForeignKey("Core.Entities.GeoLocation", "AddressLabId")
                                        .OnDelete(DeleteBehavior.Cascade);
                                });
                        });
                            ...
                            b1.OwnsOne("Core.Entities.Contact", "ContactInfo", b2 =>
                                {
                                    ...
                                    b2.HasKey("PersonLabId");

                                    b2.ToTable("Lab_Managers");

                                    b2.HasOne("Core.Entities.Person")
                                        .WithOne("ContactInfo")
                                        .HasForeignKey("Core.Entities.Contact", "PersonLabId")
                                        .OnDelete(DeleteBehavior.Cascade);
                                });
                        });
                });
            ...
            modelBuilder.Entity("Core.Entities.MotorVehiclesParametersResults", b =>
                {
                    ...
                    b.HasOne("Core.Entities.ParametersSamplingResults", "ParametersSamplingResults")
                        .WithMany("MotorVehiclesParametersResults")
                        .HasForeignKey("ParametersSamplingResultsId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
