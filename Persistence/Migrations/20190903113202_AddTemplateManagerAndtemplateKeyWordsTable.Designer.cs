...
namespace Persistence.Migrations
{
    ...
    [Migration("20190903113202_AddTemplateManagerAndtemplateKeyWordsTable")]
    partial class AddTemplateManagerAndtemplateKeyWordsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.TemplateKeywords", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("TemplateKeywordId");

                    b.Property<int>("TemplateManagerId");

                    b.HasKey("Id");

                    b.HasIndex("TemplateKeywordId");

                    b.HasIndex("TemplateManagerId");

                    b.ToTable("TemplateKeywords");
                });
            ...
            modelBuilder.Entity("Core.Entities.TemplateKeywords", b =>
                {
                    b.HasOne("Core.Entities.EnumData", "TemplateKeyword")
                        .WithMany()
                        .HasForeignKey("TemplateKeywordId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Core.Entities.TemplateManager", "TemplateManager")
                        .WithMany("TemplateKeywords")
                        .HasForeignKey("TemplateManagerId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
