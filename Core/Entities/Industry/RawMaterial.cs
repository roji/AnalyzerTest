...
{
   public class RawMaterial : IAuditableEntity, IAccessControl
   {
   ...
   public enum ProductKeepingMethods : int
   {
      [Display(Name = "انبار")] Repository = 1, [Display(Name = "فضای باز")] OpenSpace = 2
   }
}
